/**
 * Dashboard slice — identical contract to the host's version.
 *
 * This file exists in both packages/host and packages/dashboard.
 * That is intentional: the Dashboard remote owns its domain state.
 * The host registers this same reducer under the 'dashboard' key.
 * In a larger organization this would be extracted to @mf-dashboard/shared.
 */
